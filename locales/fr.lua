local Translations = {
    error = {
        ...
        no_dogs = 'Vous n\'avez aucun hot-dog à vendre. Préparez-en d\'abord !',
        already_preparing = 'Vous êtes déjà en train de préparer de la nourriture !',
    ...
    info = {
        ...
        prepare = 'Préparer un Hot-Dogs',
        toggle_sell = 'Activer/Désactiver la vente',
        ...
        sell_dogs_target = 'Vendre %{value} x Hot-Dogs pour $%{value2}',
