local Translations = {
    error = {
        ...
        no_more = 'No tiene más %{value} para preparar en este puesto',
        deposit_notreturned = 'Usted no tenía un puesto de perritos calientes',
        no_dogs = 'Usted no tiene ningún hotdogs',
        already_preparing = '¡Ya estás preparando comida!',
        minigame_unavailable = 'El sistema de minijuegos no está disponible',
    },
    success = {
        ...
        made_hotdog = 'Has hecho un %{value} perritos calientes',
        made_luck_hotdog = 'Has hecho %{value} x %{value2} perritos calientes',
    },
    info = {
